...
export default function AdminPage() {
  ...
  return <main className="admin-shell"><p className="eyebrow">Markina Gallery · Fotógrafo</p><h1>Área administrativa</h1><p className="intro">Acompanhe suas vendas e crie galerias privadas.</p><section className="admin-card"><h2>Operação</h2><p><Link href="/admin/operations">Criar cliente e galeria privada</Link></p><p><Link href="/admin/statistics">Abrir estatísticas e exportações</Link></p><p><Link href="/admin/purchases">Conferir fotos compradas</Link></p><Link href="/admin/previews">Abrir conferência por identificador</Link></section></main>;
}
