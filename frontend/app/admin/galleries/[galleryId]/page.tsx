...
export default function GalleryDetailPage() {
  ...
  return <main className="admin-shell private-gallery-detail">
    ...
    <div className="action-grid"><MarkinaButton variant="secondary" disabled={busy || !originActive} onClick={toggle}>{detail.blocked ? "Liberar acesso geral" : "Bloquear acesso geral"}</MarkinaButton>{originActive ? <Link className="mk-button mk-button--secondary" href={`/admin/galleries/sources/${detail.parent_gallery_id}/edit/vendas`}>Preço, PIX e regras herdadas</Link> : null}<Link className="mk-button mk-button--secondary" href={`/admin/galleries/${galleryId}/orders`}>Pedidos</Link><MarkinaButton className="mk-button--danger" disabled={busy} onClick={() => { setDeleteConfirmOpen(true); setDeleteError(""); }}>Excluir galeria privada</MarkinaButton></div>
