    ...
    <main className="admin-shell gallery-editor-shell">
      ...
      {currentStep === "imagens" ? (
        <section className="gallery-editor-panel">
          ...
          <form className="gallery-settings-form gallery-visual-settings" onSubmit={saveVisualSettings}><div className="section-heading"><div><p className="eyebrow">Personalização</p><h3>Marca-d’água e exibição</h3></div></div><label>Texto da marca-d’água<input name="watermark_text" defaultValue={editor.gallery.watermark_text} /></label><label>Tipografia<input name="watermark_font" defaultValue={editor.gallery.watermark_font} /></label><label>Cor<input name="watermark_color" type="color" defaultValue={editor.gallery.watermark_color} /></label><label>Tamanho<input name="watermark_size" type="number" min={10} max={96} defaultValue={editor.gallery.watermark_size} /></label><label>Direção<select name="watermark_direction" defaultValue={editor.gallery.watermark_direction}><option value="horizontal">Horizontal</option><option value="vertical">Vertical</option><option value="diagonal">Diagonal</option></select></label><label>Exibição das pastas<select name="folder_display_mode" defaultValue={editor.gallery.folder_display_mode}><option value="individual">Pastas lado a lado</option><option value="sequential">Sequência cronológica</option></select></label><MarkinaButton>Salvar personalização</MarkinaButton></form>
