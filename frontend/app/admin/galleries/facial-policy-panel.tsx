...
export function FacialPolicyPanel({ galleryId, refreshToken = 0 }: { galleryId: string; refreshToken?: number }) {
  ...
  return (
    <section className="facial-admin-panel" aria-labelledby="facial-admin-title">
      ...
      <p>Após o upload, as prévias limpas são indexadas uma única vez em segundo plano, inclusive quando contêm menores. Não existe política, declaração ou ativação manual para o administrador.</p>
