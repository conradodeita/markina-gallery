...
6. Manifesto com identidade estável e start_url neutra `/`, ícones próprios 192/512 e Apple, standalone. Componente de instalação no topo, sem popup automático: prompt nativo quando disponível; instrução para instalação manual nos navegadores reconhecidos. Ocultar em standalone ou após instalação nesta sessão. Nunca prometer instalação nativa universal.
