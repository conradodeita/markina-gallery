...
- [x] 4.3 Executar migrations, testes, lint, typecheck, build e validação OpenSpec estrita; validar homologação somente com dados sintéticos e sem ativar provedor de pagamento. **Evidência:** validações locais de migration sintética, backend, frontend e OpenSpec passaram; o run GitHub Actions `33279596997` aprovou todos os gates e publicou o SHA `751d746878aaad27885ba9297c88cf05ef5737f6` em `homolog`. O log confirmou backup lógico, Alembic `20260829_0014 (head)` — incluindo as revisions `0011` e `0012` do checkout PIX — e serviços saudáveis; `/healthz`, `/api/health` e `/admin/payments` responderam 200 externamente em 2026-08-29. Nenhum provedor de pagamento foi ativado e nenhum dado bancário real foi versionado ou usado.
