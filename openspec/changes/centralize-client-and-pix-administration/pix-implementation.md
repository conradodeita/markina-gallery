...
Este arquivo permanece como registro do recorte PIX priorizado. O diretório/lifecycle foi retomado posteriormente e seu estado atual está em `client-implementation.md`; não inferir a pendência desse escopo apenas por este parágrafo histórico. Não sincronizar specs consolidadas nem arquivar a change sem revisão humana.
