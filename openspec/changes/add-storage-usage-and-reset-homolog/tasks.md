...
- [x] 4.3 Após CI verde e merge autorizado, aprovar o Environment, executar o deploy e a limpeza sem backup novo pelo trailer exclusivo; verificar contagens operacionais e bytes zerados, admin/preferências preservados, serviços saudáveis, `FACIAL_PROCESSING_ENABLED=true` e Visão geral atualizada.
