...
- [ ] 6.4 Solicitar ao proprietário o número próprio de homologação e a leitura de QR ou uso do pairing code somente depois da infraestrutura pronta; confirmar conexão, identidade coincidente e recuperação após reinício sem registrar material sensível.
  - Bloqueio humano atual: o proprietário precisa ler o QR/código efêmero com o aparelho autorizado. A instância dedicada foi criada durante o diagnóstico, permanece sem identidade conectada e não enviou mensagens.
  - Evidência parcial em 2026-08-30: número esperado salvo; falha inicial causada pela divergência não secreta `APP_ENV=staging`/`WHATSAPP_CREDENTIAL_ENV=homolog`, corrigida para coincidência exata; provider confirmou QR e pairing code presentes sem registrar seus valores. Resta a leitura humana e a confirmação da identidade conectada.
