...
- [ ] 8.7 Submeter a experiência desktop/mobile à revisão humana em homologação, registrar bugs e evidências e manter esta task aberta até aprovação explícita.
  ...
  - [ ] 8.7.19 Após autorização específica do inventário deste fix, publicar a correção PostgreSQL pelo PR/CI e Environment existentes, confirmar SHA, head `20260903_0042` e healthchecks e liberar o reteste humano da desvinculação, sem retomar operações reais automaticamente. Autorização recebida em 2026-09-03; publicação e verificações em andamento.
