...
- [ ] 8.7 Submeter a experiência desktop/mobile à revisão humana em homologação, registrar bugs e evidências e manter esta task aberta até aprovação explícita.
  ...
  - [ ] 8.7.26 Permitir ativar, desativar e reativar tabelas globais de preço pela área administrativa, mantendo somente as ativas no dropdown e preservando versão, faixas e snapshots; verificar API idempotente, componente e ciclo real em homologação.
