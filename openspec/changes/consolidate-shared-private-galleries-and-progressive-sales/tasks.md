...
- [ ] 8.7 Submeter a experiência desktop/mobile à revisão humana em homologação, registrar bugs e evidências e manter esta task aberta até aprovação explícita.
  ...
  - [ ] 8.7.21 Após a limpeza, simular em homologação o ciclo sintético de galeria, pasta, JPEGs, cliente, vínculo e desvinculação; verificar início após confirmação, tempo até conclusão e atualização da interface, preservar evidências de eventual falha e não confundir limpeza com correção do bug.
  ...
  - [ ] 8.7.23 Tornar diálogos administrativos roláveis e com ações alcançáveis em viewport de baixa altura; verificar o componente compartilhado e a confirmação real da desvinculação em `624 × 484`.
  - [ ] 8.7.24 Após validação automatizada e autorização já concedida, publicar o fix pelo PR/CI e Environment existentes sem limpeza, confirmar SHA, head `20260903_0042`, healthchecks e repetir o fluxo sintético preservado até a atualização correta da interface.
