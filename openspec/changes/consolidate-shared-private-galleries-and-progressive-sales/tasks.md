...
- [ ] 8.7 Submeter a experiência desktop/mobile à revisão humana em homologação, registrar bugs e evidências e manter esta task aberta até aprovação explícita.
  ...
  - [ ] 8.7.20 Repetir a limpeza integral dos testes de homologação autorizada em 2026-09-03, após inventário atualizado e backup, preservando administrador, configurações e pareamento WhatsApp; verificar contagens zeradas, head, serviços e saúde externa e registrar limites de recuperação.
