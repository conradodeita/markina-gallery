...
- Permitir entrada em Galeria pública ou privada por link opaco fixo durante todo o ciclo de vida da galeria, sempre com OTP para comprovar o telefone no primeiro acesso sem sessão válida. O link privado poderá cadastrar novos membros e também vincular a Galeria pública de origem, sem conceder acesso a privadas irmãs ou a outras origens; rotação/revogação permanecerá uma operação excepcional de incidente, fora da interface cotidiana.
