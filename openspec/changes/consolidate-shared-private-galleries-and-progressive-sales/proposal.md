...
- Simplificar PIX manual para um código copia-e-cola validado, gerar o QR Code a partir dele e preservar instruções e snapshot no pedido, sem exigir um segundo campo técnico de payload.
