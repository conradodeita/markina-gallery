...
As versões de aviso, consentimento, base legal, retenção, política infantil e calibração são gates independentes. Preencher valores não autoriza dados reais: a habilitação operacional do ambiente também exige revisão humana e jurídica registrada. Depois de habilitado, o sistema cria políticas técnicas internas automaticamente; o fotógrafo não as prepara nem ativa por galeria.
...
O deploy comum recusa flag ou worker facial ativos antes de qualquer troca de SHA. Para encerrar o piloto, use a operação auditada de desligamento/limpeza, aguarde purge e confirme a prova de limpeza; não existe revogação manual por galeria no painel do fotógrafo. Em emergência, interromper a capacidade de processamento tem prioridade, mas resíduos cifrados ainda exigem limpeza posterior registrada.
