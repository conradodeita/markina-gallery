...
- Credenciais iniciais guardadas pelo proprietário por canal seguro; o arquivo temporário `/opt/markina-gallery/INITIAL_ADMIN_CREDENTIALS.txt` foi removido e sua ausência confirmada em 2026-08-25.
